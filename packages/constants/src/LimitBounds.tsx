...
export const LIMIT_KEY_BOUNDS: Record<LimitKey, {min: number; max: number}> = {
	avatar_max_size: {min: 1024, max: 50 * 1024 * 1024},
	emoji_max_size: {min: 1024, max: 10 * 1024 * 1024},
	...
	max_attachment_file_size: {min: 0, max: 1024 * 1024 * 1024},
	...
	max_guild_emojis_animated_more: {min: 0, max: 1000},
	max_guild_emojis_animated: {min: 0, max: 1000},
	max_guild_emojis_static_more: {min: 0, max: 1000},
	max_guild_emojis_static: {min: 0, max: 1000},
	...
	max_message_length: {min: 1, max: 10000},
	...
	sticker_max_size: {min: 1024, max: 10 * 1024 * 1024},
};
